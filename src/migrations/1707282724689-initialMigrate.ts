...
export class InitialMigrate1707282724689 implements MigrationInterface {
    name = 'InitialMigrate1707282724689'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "client" ADD "phone" character varying NOT NULL`);
